...
const tourSchema = new mongoose.Schema({
    ...
    //GeoJson   must have type:{} and coordinates[ latitude ,longitude ] so that it is detected as GeoJson
    startLocation: {
        type: {
            type: String,
            default: 'Point',
...
// Indexes  {{URL}}/v1/tours?price[lt]=1000
// tourSchema.index({ price: 1 });//1 asc -1 des

// Compound index  {{URL}}/v1/tours?price[lt]=1000&ratingsAverage[gte]=4.7
...
// Virtual population for the reviews of the tour instead of storing an array of the reviews' ids on each tour
...
//  Populate Middle ware for guides in Tours
