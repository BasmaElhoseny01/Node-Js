...
const server = http.createServer((req, res) => {
    ...
    if (pathName === '/product') {
        ...
        //. ==>is from where the node is running
        //__dirname ==> is where the script is located
        fs.readFile(`${__dirname}/data.json`,'utf-8', (err,data)=>{

            console.log("String",typeof(data))

            //Parse Data Read to string
            const productData=JSON.parse(data)
            console.log("Json",typeof(productData))
